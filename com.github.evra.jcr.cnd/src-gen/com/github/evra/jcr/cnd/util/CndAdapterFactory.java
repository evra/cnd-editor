/**
 */
package com.github.evra.jcr.cnd.util;
 ...
 * @generated
 */
public class CndAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static CndPackage modelPackage;
   ...
   * @generated
   */
  public CndAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = CndPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected CndSwitch<Adapter> modelSwitch =
    new CndSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.github.evra.jcr.cnd.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.github.evra.jcr.cnd.NsMapping <em>Ns Mapping</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createNsMappingAdapter()
  {
    return null;
  }
